...
<!-- ============ 个人游戏通道（2026.9.21 起按平台分成两组） ============
     ➜ 加游戏：只改本区块里对应分组的 .card-grid，新增一段 game-card 即可
        · 网页游戏  = 有可点击链接的 → 用 <a class="game-card" href="…" target="_blank">
        · 微信小游戏 = 只能扫码打开的 → 用 <div class="game-card">（无 href），
                      缩略图放小程序码，卡片点击无跳转
...
<section class="home-section home-games">
  <h2 class="home-section__title">个人游戏通道</h2>
  ...
  <div class="game-group">
    ...
    <div class="card-grid game-grid">
      <a class="game-card" href="https://meieddie.github.io/MonsterValley/" target="_blank" rel="noopener">
        <div class="game-thumb"><img class="game-thumb__cover" src="/assets/img_game/MonsterValley.png" alt="MonsterValley（怪兽谷）游戏封面"></div>
        <div class="game-info">
      ...
      <a class="game-card" href="https://meieddie.github.io/TheLastMemory/" target="_blank" rel="noopener">
        <div class="game-thumb"><img class="game-thumb__cover" src="/assets/img_game/TheLastMemory.png" alt="TheLastMemory（最后的记忆）游戏封面"></div>
        <div class="game-info">
      ...
      <a class="game-card" href="https://meieddie.github.io/Puzzle/" target="_blank" rel="noopener">
        <div class="game-thumb"><img class="game-thumb__cover" src="/assets/img_game/Puzzle.png" alt="Puzzle（迷宫）游戏封面"></div>
        <div class="game-info">
      ...
      <a class="game-card" href="https://meieddie.github.io/XiuXian/" target="_blank" rel="noopener">
        <div class="game-thumb"><img class="game-thumb__cover" src="/assets/img_game/XiuXian.png" alt="修仙·问道长生 游戏封面"></div>
        <div class="game-info">
      ...
      <a class="game-card" href="https://meieddie.github.io/TileGuard/" target="_blank" rel="noopener">
        <div class="game-thumb"><img class="game-thumb__cover" src="/assets/img_game/TileGuard.png" alt="TileGuard（合成塔防）游戏封面"></div>
        <div class="game-info">
      ...
      <a class="game-card" href="https://meieddie.github.io/Gravity/" target="_blank" rel="noopener">
        <div class="game-thumb"><img class="game-thumb__cover" src="/assets/img_game/Gravity.png" alt="Gravity（引力弹弓）游戏封面"></div>
        <div class="game-info">
      ...
      <a class="game-card" href="https://meieddie.github.io/TrapTheKitten/" target="_blank" rel="noopener">
        <div class="game-thumb"><img class="game-thumb__cover" src="/assets/img_game/TrapTheKitten.png" alt="TrapTheKitten（围住小猫）游戏封面"></div>
        <div class="game-info">
  ...
  <div class="game-group">
    ...
    <div class="card-grid game-grid">
      ...
      <div class="game-card">
        <div class="game-thumb"><img src="/assets/img_game/小程序码.png" alt="占领蚂蚁窝小程序码"></div>
        <div class="game-info">
