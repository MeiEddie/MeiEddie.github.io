...
# 「友链」页（顶栏「文章专区」右侧入口）。
#
# 目录结构（2026.9.24 二十八轮改版：目录收平成单文件）：
#   docs/友链.md                  ← 本文件（URL 是 /友链，产物是 友链.html）
#   docs/assets/img_友链/*.webp   ← 友链头像，页内用**绝对路径** /assets/img_友链/xxx.webp 引用
# ⚠️ 页面在目录里时（docs/友链/index.md）路由是 /友链/、nav 链接**要带斜杠**；
#    提成单文件后路由是 /友链、nav 链接**不能带斜杠** —— 两者选错都是线上 404（各踩过一次）。
#
...
<section class="home-section">
  ...
  <!-- ⬇️⬇️⬇️ 维护入口：一个 <a class="friend-card"> = 一条友链，竖向依次排列。
       每条友链四个信息：① 头像 = .friend-avatar 里的 <img src="/assets/img_友链/xxx.webp">
       （图片统一放 docs/assets/img_友链/ 下，路径写**绝对路径** /assets/img_友链/…；
       2026.9.24 起全站图片一律 .webp —— 原来 ./头像/1.png、./头像/2.jpg 已转成 1.webp、2.webp。
       一律绝对路径的原因：中文文件名 + 相对路径会在 build 时 Could not resolve 直接挂。
       暂时没有图就只留 <span class="friend-avatar__initial">首字</span>，补上 <img> 后首字自动隐藏，不会破图）；
  ...
  <div class="friend-list">
    <a class="friend-card" href="https://meteorliu.zehao.asia/" target="_blank" rel="noopener">
      <div class="friend-avatar">
        <img src="/assets/img_友链/1.webp" alt="流星MeteorLiu" />
      </div>
    ...
    <a class="friend-card" href="https://asadsoul.github.io/soulsblog.github.io" target="_blank" rel="noopener">
      <div class="friend-avatar">
        <img src="/assets/img_友链/2.webp" alt="a_sad_soul" />
      </div>
      <div class="friend-info">
